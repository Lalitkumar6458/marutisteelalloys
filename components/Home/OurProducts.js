      ...
      >
        <Slider {...settings}>
          {productData.map((item) => {
            return (
              <div
                className="h-[500px] mr-[10px] rounded p-2 shadow-boxshadow relative border border-dark-cl"
                key={item.id}
              >
                <div className="">
                  <div className="overflow-hidden rounded-md">
                    <Image
                      className="w-full h-[250px] rounded-md border hover:scale-110 transition-all duration-700 ease-in-out"
                      src={item.img}
                      alt={item.heading}
                      width={600}
                      height={500}
                  ...
                  <div className="bg-white mt-2">
                    <h3 className="text-[1.4rem] font-Roboto font-medium text-dark-cl">
                      {item.heading}
                    </h3>
                    <p className="text-[0.84rem] font-poppins font-medium">
                      {item.desc}
                    </p>
                  </div>
                  <div className="bottom-2 absolute left-3">
                    <Link
                      href={item.link}
                      className="flex items-center text-[1rem] text-dark-pink gap-3 font-medium"
                    >
